...
\captionof{figure}{Distribuzione esponenziale con $\lambda = 1$}
\
...
**La Normale Standard $Z \sim \mathcal{N}(0,1)$**
...
% Normal distribution X ~ \mathcal{N}(4,0.09)
